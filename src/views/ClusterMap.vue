<template>
        <!--顶部-->
    <div class="total_chose_box" style="position: absolute;top:7%">
        ...
        <div class="con_left" style="flex: 1;">
            ...
            <div class="div_any" >
                <div class="left div_any01" style="width:600px;">
                    <div class="div_any_child" style="width:598px;position:absolute;top:15%;left:7%;">
                ...
                <div class="left div_any01" style="width:600px;">
                    <div class="div_any_child" style="width:598px;position:absolute;top:70%;left:7%;">
        ...
        <div class="con_right" style="flex: 1;">
            <div class="div_any">
                <div class="left div_any01" style="width:800px;">
                    <div class="div_any_child" style="width:798px;position:absolute;top:15%;right:5%">
